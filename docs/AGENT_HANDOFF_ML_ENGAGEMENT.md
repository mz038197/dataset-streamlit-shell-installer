...
- **page 14–18**（單／多變量回歸、邏輯迴歸、正則化邏輯迴歸、線性支援向量機）：**僅內建範例資料**，不提供 `ready.csv` 切換（2026-07-21 定案；對齊 page 19–20）。
...
## 5. 已實作：線性支援向量機（雙階段＋訓練前預測）

### 決策

- 側欄／頁面標題用 **「線性支援向量機」**（僅 linear kernel；kernel／非線性列為未做）。
