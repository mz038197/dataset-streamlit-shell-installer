...
**Consequences**：推翻 ADR-0011「換公司還原空殼」與「換公司清 runtime」。空殼只在該公司尚無（區函式形狀的）快照時載入；舊整頁檔不當快照，見 ADR-0028。Agent 只改 live UI 與目前公司資料夾。F5 不保存對話。安裝／`--force` 須把學生的 Challenge 工作資料／切分從備份還原，不可只留在 `.bak`。
